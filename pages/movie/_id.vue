...
export default {
  ...
  data () {
    return {
      ...
      activeMenu: 'overview',
      recommended: null,
      myvideo: [{id:1, name: 'Myvideo', url: 'https://historical-deciduous-antimatter.glitch.me/stream/339BE5B6F215AB211226368305839D804C102A59',thumb: 'https://image.tmdb.org/t/p/w370_and_h556_bestv2/5MSDwUcqnGodFTvtlLiLKK0XKS.jpg', duration: 200, type: 'stream'}],
    };
  },
